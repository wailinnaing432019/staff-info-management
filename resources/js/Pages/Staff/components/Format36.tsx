        ...
        <div className="bg-white p-4 md:p-8 max-w-4xl mx-auto my-4 text-black   text-[14px] leading-relaxed select-none print:border-0 print:shadow-none print:p-0 print:m-0 print:max-w-full">
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-[240px_20px_1fr] items-start">
                    ...
                    <div className="text-center">-</div>
                    <div className="text-gray-900">{data.religion || "-"}</div>
                </div>
                <div className="grid grid-cols-[240px_20px_1fr] items-start">
                    <div className="  ">
                        ၇။ လူမျိုး <br />{" "}
            ...
            <div className="mb-6 keep-together">
                <h4 className=" mb-2">
                    ၁၉။ ပညာဆည်းပူးခဲ့သောကျောင်း၊ ကောလိပ်၊ တက္ကသိုလ်၊ အလုပ်ဌာန၊
                    သင်တန်း စသည်များ
                </h4>
                <table className="w-full border border-black border-collapse  text-center">
                    <tbody>
            ...
            <div className="my-6 keep-together ">
                ...
                <table className="w-full border border-black border-collapse  text-center">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="border border-black p-2">
                                {data.foreign_visited_purpose?.time_period ||
                                    "-"}
                            </td>
                            <td className="border border-black p-2">
                                {data.foreign_visited_purpose?.arrival_date ||
                                    "-"}
                            </td>
                            <td className="border border-black p-2">
                                {data.foreign_visited_purpose
                ...
                <div className="grid grid-cols-[240px_20px_1fr] items-start">
                    <div className=" ">
                        နိုင်ငံခြားသို့သွားရောက်မည့် ကိစ္စနှင့်အထောက်အထားများ
                    </div>
                    <div className="text-center">-</div>
                    <div className=" ">
            ...
            <div className=" ">
                <div className="keep-together">
                    ...
                    <div className="flex   justify-around">
                        ...
                        <div className="space-y-2 p-4     rounded-lg print:border-0 print:p-0">
                            ...
                            <div>
                                <span className="w-36 inline-block">အမည် </span>
                                -{" "}
                                <span className="ml-2">
                                    {data.name ||
                                        "............................................"}
                            ...
                            <div>
                                <span className="w-36 inline-block">ဌာန </span>{" "}
                                -{" "}
                                <span className="ml-2">
                                    {data.employment?.department ||
                                        "............................................"}
                ...
                <div className="keep-together">
                    <p className="  mb-6  ">၃၅။ ထပ်ဆင့် လက်မှတ်ရေးထိုးပါသည်။</p>
                    <div className="flex   justify-around">
                        <div className="text-[13px] mt-2">ရက်စွဲ -</div>
                        <div className="space-y-2 p-4     rounded-lg print:border-0 print:p-0">
                            <p className="text-center   pb-1 mb-2 print:text-left">
                ...
                <div className="keep-together">
                    <p className="  mb-6  ">၃၆။ ထပ်ဆင့် လက်မှတ်ရေးထိုးပါသည်။</p>
                    <div className="flex   justify-around">
                        <div className="text-[13px] mt-2">ရက်စွဲ -</div>
                        <div className="space-y-2 p-4     rounded-lg print:border-0 print:p-0">
                            <p className="text-center   pb-1 mb-2 print:text-left">
