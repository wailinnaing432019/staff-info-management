        ...
        <>
            ...
            <div className="bg-white p-4 md:p-8 max-w-4xl mx-auto my-4 text-black font-serif text-[14px] leading-relaxed select-none print:border-0 print:shadow-none print:p-0 print:m-0 print:max-w-full">
                ...
                <div className="flex justify-between items-start mb-6 screen-secret">
                    <div className="   border border-black px-3 py-0.5">ပုံစံ (၃၆)</div>
                    <div className="text-base   tracking-widest border border-black px-4 py-0.5">လျှို့ဝှက်</div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-[240px_20px_1fr] items-start">
                        <div className="  ">၇။ လူမျိုး <br /> (လူမျိုးစုဖြစ်လျှင်လိုအပ်သလိုဖော်ပြရန်)</div>
                        <div className="text-center">-</div>
                        <div className="text-gray-900">
                            {data.race || '-'}
                        </div>
                    ...
                    <div className="grid grid-cols-[240px_20px_1fr] items-start">
                        ...
                        <div className="text-center">-</div>
                        <div className="font-medium tracking-wide ">{data.nrc_township || ''}
                    ...
                    <div className="grid grid-cols-[240px_20px_1fr] items-start">
                        <div className="  ">၁၆။ လက်ရှိနေရပ် လိပ်စာ အပြည့်အစုံ</div>
                        <div className="text-center">-</div>
                        <div className="text-gray-900 break-words">{data.info?.current_address || '-'}</div>
                    </div>

                    <div className="grid grid-cols-[240px_20px_1fr] items-start">
                        <div className="  ">၁၇။ အမြဲတမ်းနေရပ် လိပ်စာ အပြည့်အစုံ</div>
                        <div className="text-center">-</div>
                    ...
                    <table className="w-full border border-black border-collapse  text-center">
                        ...
                        <tbody>
                            {data.educations?.length > 0 ? (
                                ...
                                <tr>
                                    <td className="border border-black p-4 text-gray-400 ">မှတ်တမ်းမရှိပါ။</td>
                                    <td className="border border-black p-4 text-gray-400 ">မှတ်တမ်းမရှိပါ။</td>
                                    <td className="border border-black p-4 text-gray-400 ">မှတ်တမ်းမရှိပါ။</td>
                                    <td className="border border-black p-4 text-gray-400 ">မှတ်တမ်းမရှိပါ။</td>
                                </tr>
                ...
                <div className="mb-6 keep-together">
                    <h4 className=" mb-2">၁၉။ ပညာဆည်းပူးခဲ့သောကျောင်း၊ ကောလိပ်၊ တက္ကသိုလ်၊ အလုပ်ဌာန၊ သင်တန်း စသည်များ</h4>
                    <table className="w-full border border-black border-collapse  text-center">
                                ...
                                return educations.length > 0 ? (
                                    educations.map((item, idx) => (
                                        <tr key={idx}>
                                            ...
                                            <td className="border border-black p-2">{item.rank || '-'}</td>
                                        </tr>
                                    ))
                                ) : (
                                    <tr>
                                        <td className="border border-black p-4 text-gray-400  text-center"> </td>
                                        <td className="border border-black p-4 text-gray-400  text-center"> </td>
                                        <td className="border border-black p-4 text-gray-400  text-center"> </td>
                                        <td className="border border-black p-4 text-gray-400  text-center"> </td>
                                        <td className="border border-black p-4 text-gray-400  text-center"> </td>
                ...
                <div className="mb-6 keep-together">
                    <h4 className=" mb-2">၂၀။ နိုင်ငံခြားသို့ရောက်ဖူးခြင်း ရှိ/ မရှိ {data.abroad_visits?.length > 0 ? "(ရှိ)" : "(မရှိ)"}</h4>
                    <table className="w-full border border-black border-collapse  text-center">
                        <thead>
                            <tr className="bg-gray-50 font-bold border-b border-black">
                                <th className="border border-black p-2" >မှ <br /> (ရက်/လ/နှစ်)</th>
                                <th className="border border-black p-2" >ထိ <br /> (ရက်/လ/နှစ်)</th>
                                <th className="border border-black p-2" >သွားရောက်သည့်နိုင်ငံများ</th>
                                <th className="border border-black p-2" >သွားရောက်သည့်ကိစ္စ</th>
                                <th className="border border-black p-2" >နိုင်ငံခြားငွေမည်မျှ ထုတ်ယူခဲ့သည်</th>
                            </tr>
                ...
                <div className="space-y-6">
                    ...
                    <div className="keep-together"><FamilyTable title="၂၄။ ဇနီးခင်ပွန်းနှင့် ၎င်း၏မောင်နှမအရင်းအချာများ။" relationshipType="spouse_family" familiesData={data.family_members} /></div>
                ...
                <div className="mb-6 keep-together">
                    <h4 className=" mb-2">၃၁။ ဘွဲ့/ တံဆိပ် ချီးမြှင့်ခံရဖူးခြင်း ရှိ/ မရှိ {data.awards_received?.length > 0 ? "(ရှိ)" : "(မရှိ)"}</h4>
                    <table className="w-full border border-black border-collapse  text-center">
                        <thead>
                            <tr className="bg-gray-50 font-bold border-b border-black">
                                <th className="border border-black p-2">ချီးမြှင့်ခံရသည့် ကာလ</th>
                                <th className="border border-black p-2">ချီးမြှင့်ခံရသည့်ဘွဲ့/ တံဆိပ်အမျိုးအစား</th>
                                <th className="border border-black p-2 w-64">မှတ်ချက်</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-black">
                            {data.awards_received?.length > 0 ? (
                                data.awards_received.map((item, idx) => (
                                    <tr key={idx}>
                                        <td className="border border-black p-2">{item.award_period}</td>
                                        <td className="border border-black p-2 text-left px-3 ">{item.award_title || '-'}</td>
                                        <td className="border border-black p-2 ">{item.award_remark || '-'}</td>
                                    </tr>
                                ))
                            ) : (
                                <tr>
                                    <td className="border border-black p-4 text-gray-400 "> </td>
                                    <td className="border border-black p-4 text-gray-400 "> </td>
                                    <td className="border border-black p-4 text-gray-400 "> </td>
                                </tr>
                            )}
                ...
                <div className="my-6 keep-together ">
                    ...
                    <div className="grid mt-2 grid-cols-[240px_20px_1fr] items-start">
                        ...
                        <div className="text-center">-</div>
                        <div className=" ">{data.foreign_visited_purpose?.destination_country || '-'}</div>
                    </div>
                    <div className="grid grid-cols-[240px_20px_1fr] items-start">
                        <div className=" ">နိုင်ငံခြားသို့သွားရောက်မည့် ကိစ္စနှင့်အထောက်အထားများ</div>
                        <div className="text-center">-</div>
                        <div className=" ">{data.foreign_visited_purpose?.foreign_visit_details || '-'}</div>
                    </div>
                </div>
                ...
                <div className=" ">
                    <div className="keep-together">
                        ...
                        <div className="flex   justify-around">
                            ...
                            <div className="space-y-2 p-4     rounded-lg print:border-0 print:p-0">
                                <p className="  pb-1 mb-2 print:text-left">လျှောက်ထားသူလက်မှတ်</p>

                                <div><span className='w-36 inline-block'>အမည် </span>- <span className="ml-2">{data.name || '............................................'}</span></div>
                                <div><span className='w-36 inline-block'>ရာထူး </span> - <span className='ml-2'>{data.employment?.position || '............................................'}</span></div>
                                <div><span className='w-36 inline-block'>ဌာန </span> - <span className='ml-2'>{data.employment?.department || '............................................'}</span></div>
                    ...
                    <div className="keep-together">
                        <p className="  mb-6  ">
                            ၃၄။ ဝန်ထမ်း၏ လုပ်ရည်ကိုင်ရည်နှင့်အကျင့်စာရိတ္တထောက်ခံသူ
                        </p>
                        <div className="flex   justify-around">
                            <div className="text-[13px] mt-2">ရက်စွဲ -</div>
                            <div className="space-y-2 p-4     rounded-lg print:border-0 print:p-0">
                                <p className="text-center   pb-1 mb-2 print:text-left"> လက်မှတ်</p>

                                <div><span className='w-36 inline-block'>အမည် </span>- <span className=" ml-2">{data.referee?.referee_name || '............................................'}</span></div>
                                <div><span className='w-36 inline-block'>ရာထူး </span> - <span className='ml-2'>{data.referee?.referee_position || '............................................'}</span></div>
                                <div><span className='w-36 inline-block'>ဌာန </span> - <span className='ml-2'>{data.referee?.referee_department || '............................................'}</span></div>
                    ...
                    <div className="keep-together">
                        ...
                        <div className="flex   justify-around">
                            <div className="text-[13px] mt-2">ရက်စွဲ -</div>
                            <div className="space-y-2 p-4     rounded-lg print:border-0 print:p-0">
                                <p className="text-center   pb-1 mb-2 print:text-left">(ပါမောက္ခချုပ်/ ကျောင်းအုပ်ကြီးလက်မှတ်)</p>

                                <div><span className='w-36 inline-block'>အမည် </span>- <span className=" ml-2">{data.referee?.rector_name || '............................................'}</span></div>
                                <div><span className='w-36 inline-block'>ရာထူး </span> - <span className='ml-2'>{data.referee?.rector_position || '............................................'}</span></div>
                                <div><span className='w-36 inline-block'>ဌာန </span> - <span className='ml-2'>{data.referee?.rector_department || '............................................'}</span></div>
                    ...
                    <div className="keep-together">
                        ...
                        <div className="flex   justify-around">
                            <div className="text-[13px] mt-2">ရက်စွဲ -</div>
                            <div className="space-y-2 p-4     rounded-lg print:border-0 print:p-0">
                                <p className="text-center   pb-1 mb-2 print:text-left">(ဌာနအကြီးအကဲ လက်မှတ်)</p>

                                <div><span className='w-36 inline-block'>အမည် </span>- <span className=" ml-2">{data.referee?.dept_head_name || '............................................'}</span></div>
                                <div><span className='w-36 inline-block'>ရာထူး </span> - <span className='ml-2'>{data.referee?.dept_head_position || '............................................'}</span></div>
                                <div><span className='w-36 inline-block'>ဌာန </span> - <span className='ml-2'>{data.referee?.dept_head_department || '............................................'}</span></div>
                ...
                <div className="flex justify-end mt-12 screen-secret">
                    <div className="text-base font-bold  border border-black px-4 py-0.5">လျှို့ဝှက်</div>
                </div>
