            ...
            <div className="bg-white p-6 md:p-12 max-w-4xl mx-auto my-6 text-black font-serif select-none print:border-0 print:shadow-none print:p-0 print:m-0 print:max-w-full relative">
                ...
                <div className="flex justify-between items-end mb-6 pt-2 relative">
                    ...
                    <div className="text-center flex-1">
                        <h2 className="text-md -ml-40 font-bold tracking-wide  inline-block pb-1 px-4">
                            ကိုယ်ရေးမှတ်တမ်း
                        </h2>
                    </div>
                ...
                <div className="text-[14px] space-y-2.5 py-2">
                    ...
                    <div className="grid grid-cols-[200px_20px_1fr] items-start">
                        ...
                        <div className="text-center">-</div>
                        <div className="">{data.staff_number || data.id || '-'}</div>
                    </div>
                    ...
                    <div className="grid grid-cols-[200px_20px_1fr] items-start">
                        ...
                        <div className="text-center">-</div>
                        <div className="font-medium">{data.nrc_township || ''}
                    ...
                    <div className="grid grid-cols-[200px_20px_1fr] items-start">
                        ...
                        <div className="text-center">-</div>
                        <div className="break-words">{data.info?.childrens || '-'}</div>
                    </div>

                    <div className="grid grid-cols-[200px_20px_1fr] items-start">
                        <div className="">၁၀။ လိပ်စာ</div>
                        <div className="text-center">-</div>
                        <div className="break-words">{data.info?.permanent_address || '-'}</div>
                    </div>

                    <div className="grid grid-cols-[200px_20px_1fr] items-start">
                        <div className="">၁၁။ ပညာအရည်အချင်း</div>
                        <div className="text-center">-</div>
                        <div className="break-words">{data.info?.degree || '-'}</div>
                    </div>
                ...
                <div className="space-y-6 mt-6">
                    ...
                    <div className="keep-together">
                        <h4 className="text-sm  mb-2">၁၄။ နိုင်ငံ့ဝန်ထမ်းတာဝန်ထမ်းဆောင်မှုမှတ်တမ်း (စစ်ဘက်/ နယ်ဘက်)</h4>
                        <table className="w-full border-1 border-black border-collapse text-xs text-center">
                            <thead>
                                <tr className="bg-gray-100 font-bold border-b-1 border-black">
                                    ...
                                    <th colSpan={2} className="border border-black p-1.5">တာဝန်ထမ်းဆောင်သည့် ကာလ </th>
                                ...
                                {data.service_records?.length > 0 ? (
                                    data.service_records.map((item, idx) => (
                                        <tr key={idx} className="align-middle">
                                            ...
                                            <td className="border border-black p-1.5">{item.service_to || '-'}</td>
                                            <td className="border border-black p-1.5">{item.service_location || '-'}</td>
                                        </tr>
                                    ))
                                ) : (
                                    <tr>
                                        <td className="border border-black p-4 italic">-</td>
                                        <td className="border border-black p-4 italic">-</td>
                                        <td className="border border-black p-4 italic">-</td>
                                        <td className="border border-black p-4 italic">-</td>
                                        <td className="border border-black p-4 italic">-</td>
                    ...
                    <div className="keep-together">
                        <h4 className="text-sm  mb-2">၁၅။ ပြည်တွင်းသင်တန်းများ တက်ရောက်မှု</h4>
                        <table className="w-full border-1 border-black border-collapse text-xs text-center">
                            <thead>
                                <tr className="bg-gray-100 font-bold border-b-1 border-black">
                                    <th rowSpan={2} className="border border-black p-1.5 w-12">စဉ်</th>
                                    <th rowSpan={2} className="border border-black p-1.5">သင်တန်းအမည်</th>
                                    <th colSpan={2} className="border border-black p-1.5">တက်ရောက်သည့်ကာလ </th>
                                    <th rowSpan={2} className="border border-black p-1.5">နေရာ/ ဒေသ</th>
                                </tr>
                                <tr className="bg-gray-100 font-bold border-b-1 border-black">
                                    <th className="border border-black p-1.5"> မှ </th>
                    ...
                    <div className="keep-together">
                        <h4 className="text-sm  mb-2">၁၆။ ပြည်ပသင်တန်းများ တက်ရောက်မှု</h4>
                        <table className="w-full border-1 border-black border-collapse text-xs text-center">
                            <thead>
                                <tr className="bg-gray-100 font-bold border-b-1 border-black">
                                    <th rowSpan={2} className="border border-black p-1.5 w-12">စဉ်</th>
                            ...
                            <tbody className="divide-y divide-black">
                                {(() => {
                                    ...
                                    return foreignTrainings.length > 0 ? (
                                        ...
                                        <tr>
                                            <td colSpan={5} className="border border-black p-4 italic text-center">ပြည်ပသင်တန်း တက်ရောက်ခဲ့သည့် မှတ်တမ်းမရှိပါ။</td>
                                        </tr>
                                    );
                                })()}
                            </tbody>
                        ...
                        <table className="w-full border-1 border-black border-collapse text-xs text-center">
                            ...
                            <tbody className="divide-y divide-black">
                                {data.criminal_records?.length > 0 ? (
                                    ...
                                    <tr>
                                        <td colSpan={4} className="border border-black p-4 italic text-center">ပြစ်မှုမှတ်တမ်း လုံးဝမရှိပါ။</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
                    ...
                    <div className="keep-together">
                        <h4 className="text-sm  mb-2">၁၈။ ချီးမြှင့်ခံရသည့် ဘွဲ့ထူး၊ ဂုဏ်ထူးတံဆိပ်များ</h4>
                        <table className="w-full border-1 border-black border-collapse text-xs text-center">
                            <thead>
                                <tr className="bg-gray-100 font-bold border-b-1 border-black">
                                    <th className="border border-black p-1.5 w-12">စဉ်</th>
                                    <th className="border border-black p-1.5">ဘွဲ့ထူး၊ ဂုဏ်ထူးတံဆိပ် အမည်</th>
                            ...
                            <tbody className="divide-y divide-black">
                                {data.awards_received?.length > 0 ? (
                                    ...
                                    <tr>
                                        <td colSpan={3} className="border border-black p-4 italic text-center">မှတ်တမ်းမရှိပါ။</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
                    ...
                    <div className="mt-8 text-[13px] leading-relaxed keep-together">
                        <p className="  mb-6">အထက်ပါ ဖြည့်စွက်ချက်များ မှန်ကန်ကြောင်း လက်မှတ်ရေးထိုးပါသည်။</p>
                        ...
                        <div className="  mt-4">
                            ...
                            <div className="w-80 mx-auto space-y-3">
                                ...
                                <div className="flex">
                                    ...
                                    <div className="px-1">-</div>
                                    <div className="flex-1  ">{data.employment?.position || ''}</div>
                                </div>
                                <div className="flex">
                                    <div className="w-44 shrink-0">ဖုန်းနံပါတ် (ရုံး/လက်ကိုင်ဖုန်း)</div>
                                    <div className="px-1">-</div>
                                    <div className="flex-1  ">{data.info?.mobile_phno || ''}</div>
                                </div>
                                <div className="flex">
                                    <div className="w-44 shrink-0">အီးမေးလ်</div>
                                    <div className="px-1">-</div>
                                    <div className="flex-1  ">{data.info?.email || ''}</div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center mt-8 gap-1 pt-2">
                                ...
                                <span>  ခုနှစ်၊</span> <span className="w-16 border-b border-black text-center inline-block"></span>
                                <span>လ (</span>
